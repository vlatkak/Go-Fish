...
export class Player extends GameParticipant {
  ...
  constructor(cardHand: Array<Card>) {
    ...
    this.sprites.receivingCard = "../../assets/opponent/giving_card.webp"
    this.sprites.givingCard = "../../assets/opponent/receiving_card.webp"
    this.sprites.collectedSet = "../../assets/opponent/idle.webp"
    this.sprites.drawingCard = "../../assets/opponent/player_drawing_card.webp"
  }
}
